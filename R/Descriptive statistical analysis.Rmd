...
```{r}
m1 <- svy_tableone(design = nhs,
             cv = c('age','neutrophil','wbc'),
             c_meanPMse = TRUE,
             gv = c('sex','edu','marital','eth','povertynew','bminew','smoke','alcohol','prebioticnew','microbe','medQ','aheiQ','diiQ','heiQ'),
             by ='arghritis_type')
write.csv(m1,file = '人口学1.csv')

m2 <- svy_tableone(design = nhs,
             cv = c('age','neutrophil','wbc'),
             c_meanPMse = TRUE,
             gv = c('sex','edu','marital','eth','povertynew','bminew','smoke','alcohol','arghritis_type','medQ','aheiQ','diiQ','heiQ'),
             by = 'prebioticnew')
write.csv(m2,file = '人口学2.csv')

m3 <- svy_tableone(design = nhs,
             cv = c('age','neutrophil','wbc'),
             c_meanPMse = TRUE,
             gv = c('sex','edu','marital','eth','povertynew','bminew','smoke','alcohol','arghritis_type','medQ','aheiQ','diiQ','heiQ'),
             by = 'microbe')
write.csv(m3,file = '人口学3.csv')
